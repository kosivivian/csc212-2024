...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer07b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer07a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer06b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer06a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer05b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer05a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer04b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer04a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer03b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer03a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer02b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer02a.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer01b.png"));
    backgroundTextures.push_back(loadTexture("./Background 03 - Forest Night-Dark/PALALLAX/layer01a.png"));
